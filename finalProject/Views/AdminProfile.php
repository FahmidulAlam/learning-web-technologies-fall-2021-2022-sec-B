	...
	<table border="1" width="100%">
		<tr>
			<td colspan="2" height="60px" width="10%"><img src="Logo.PNG" alt="FA Bank Ltd."></td>
			 <td align="right"> <a href="AdminHome.php">Home | </a><a href="AdminRegistration.php">Registration | </a> <a href="../Controller/LogoutCheck.php">Logout </a></td>
		</tr>
		<tr>
			<td colspan="3" height="500px">
				...
				<ul>
					...
					<li><a href="ComplainList.php">Complain Box </a><br></li>
