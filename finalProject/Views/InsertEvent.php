...
<body>
	<form method="POST" action="../Controller/eventFile.php" enctype="multipart/form-data">
	<table border="1" width="100%">
		...
		<tr>
			<td colspan="3" height="500px">
					...
					<fieldset>
						<legend><b>Upload New Event</b></legend>

									<fieldset><legend>Date</legend>
										<input type="date" name="date" value="">
									</fieldset><br>

								    <fieldset><legend>Subject of Event</legend><input type="text" name="subject" value="" id="subject" onkeyup="()" onblur="()"></fieldset><br> 

							        <fieldset><legend>Write Event</legend><textarea name="eventDetails" value="eventDetails" ></textarea></fieldset><br> 
