...
<body>
	...
	<form method="post" action="../controller/eventUpdate.php" enctype = "multipart/form-data">
		<fieldset>
			...
			<table>
				...
				<tr>
					<td>Event:</td>
					<td><input type="text" name="eventDetails" value="<?=$user['eventDetails']?>" id="eventDetails" onkeyup="()" onblur="()"></td>
				</tr>
				<tr>
					<td>File:</td>
